 ...
 * @addtogroup Drivers
 * @{
 * @addtogroup SPI_Flash SPI flash memory
 * @brief SPI flash memory driver API
 * @{
 *
 * @file spi_flash.h
 *
 * @brief SPI flash memory driver header file.
 *
 * @details Tested SPI flash memory devices:
 *          - Winbond: W25x10, W25x20
 *          - Renesas: AT25xy512C (tested AT25XE512C, AT25DF512C)
 *                     AT25xy011 (tested AT25DF011, AT25DN011, AT25XE011)
 *                     AT25EU0011A
 *                     AT25xy021A (tested AT25DF021A, AT25XE021A)
 *                     AT25EU0021A
 *                     AT25XE041B
 *                     AT25FF041A
 *                     AT25SF041B
...
#define SPI_FLASH_SIZE_512KBIT                  (512 * 1024 / 8)
#define SPI_FLASH_SIZE_1MBIT                    (1024 * 1024 / 8)
#define SPI_FLASH_SIZE_2MBIT                    (2 * 1024 * 1024 / 8)
#define SPI_FLASH_SIZE_4MBIT                    (4 * 1024 * 1024 / 8)
#define SPI_FLASH_SIZE_8MBIT                    (8 * 1024 * 1024 / 8)
#define SPI_FLASH_SIZE_16MBIT                   (16 * 1024 * 1024 / 8)
...
#define W25x10CL_CHIP_SIZE                      SPI_FLASH_SIZE_1MBIT
...
#define W25x20CL_CHIP_SIZE                      SPI_FLASH_SIZE_2MBIT
...
#define MX25V1006E_CHIP_SIZE                    SPI_FLASH_SIZE_1MBIT
...
#define MX25R1035F_CHIP_SIZE                    SPI_FLASH_SIZE_1MBIT
...
#define MX25R2035F_CHIP_SIZE                    SPI_FLASH_SIZE_2MBIT
...
#define MX25R4035F_CHIP_SIZE                    SPI_FLASH_SIZE_4MBIT
...
#define MX25R8035F_CHIP_SIZE                    SPI_FLASH_SIZE_8MBIT
...
#define MX25R1635F_CHIP_SIZE                    SPI_FLASH_SIZE_16MBIT
...
#define MX25V1035F_CHIP_SIZE                    SPI_FLASH_SIZE_1MBIT
...
#define MX25V2035F_CHIP_SIZE                    SPI_FLASH_SIZE_2MBIT
...
#define MX25V4035F_CHIP_SIZE                    SPI_FLASH_SIZE_4MBIT
...
#define MX25V8035F_CHIP_SIZE                    SPI_FLASH_SIZE_8MBIT
...
#define MX25V1635F_CHIP_SIZE                    SPI_FLASH_SIZE_16MBIT
...
#define P25Q10U_CHIP_SIZE                       SPI_FLASH_SIZE_1MBIT
...
#define P25Q11U_CHIP_SIZE                       SPI_FLASH_SIZE_1MBIT
...
#define P25Q40U_CHIP_SIZE                       SPI_FLASH_SIZE_4MBIT
...
#define GD25WD10_CHIP_SIZE                      SPI_FLASH_SIZE_1MBIT
...
#define GD25WD20_CHIP_SIZE                      SPI_FLASH_SIZE_2MBIT
#define GD25WD20_MEM_PROT_LOWER_HALF            20
#define GD25WD20_MEM_PROT_ALL                   24
///@}

/// @name AT25XE512C, AT25DF512C - specific definitions
///@{
/** AT25XE512C, AT25DF512C - specific */
#define AT25xy512C_JEDEC_ID                     0x1F6501
#define AT25xy512C_CHIP_SIZE                    SPI_FLASH_SIZE_512KBIT
#define AT25xy512C_MEM_PROT_ALL                 0x04
///@}

/// @name AT25DF011, AT25DN011, AT25XE011 - specific definitions
///@{
/** AT25DF011, AT25DN011, AT25XE011 - specific */
#define AT25xy011_JEDEC_ID                      0x1F4200
#define AT25xy011_CHIP_SIZE                     SPI_FLASH_SIZE_1MBIT
#define AT25xy011_MEM_PROT_ALL                  0x04
///@}

/// @name AT25EU0011A - specific definitions
///@{
/** AT25EU0011A - specific */
#define AT25EU0011A_JEDEC_ID                    0x1F1001
#define AT25EU0011A_CHIP_SIZE                   SPI_FLASH_SIZE_1MBIT
#define AT25EU0011A_MEM_PROT_ALL                0x7C
///@}

/// @name AT25DF021A, AT25XE021A - specific definitions
///@{
/** AT25DF021A, AT25XE021A - specific */
#define AT25xy021A_JEDEC_ID                     0x1F4301
#define AT25xy021A_CHIP_SIZE                    SPI_FLASH_SIZE_2MBIT
#define AT25xy021A_MEM_PROT_ALL                 0x7F
#define AT25xy021A_MEM_PROT_STATUS              0x0C
///@}
...
#define AT25EU0021A_CHIP_SIZE                   SPI_FLASH_SIZE_2MBIT
#define AT25EU0021A_MEM_PROT_ALL                0x7C
///@}

/// @name AT25XE041B - specific definitions
///@{
/** AT25XE041B - specific */
#define AT25XE041B_JEDEC_ID                     0x1F4402
#define AT25XE041B_CHIP_SIZE                    SPI_FLASH_SIZE_4MBIT
#define AT25XE041B_MEM_PROT_ALL                 0x3C
///@}

/// @name AT25FF041A - specific definitions
///@{
/** AT25FF041A - specific */
#define AT25FF041A_JEDEC_ID                     0x1F4408
#define AT25FF041A_CHIP_SIZE                    SPI_FLASH_SIZE_4MBIT
#define AT25FF041A_MEM_PROT_ALL                 0x1C
///@}

/// @name AT25SF041B - specific definitions
///@{
/** AT25SF041B - specific */
#define AT25SF041B_JEDEC_ID                     0x1F8401
#define AT25SF041B_CHIP_SIZE                    SPI_FLASH_SIZE_4MBIT
#define AT25SF041B_MEM_PROT_ALL                 0x7C
///@}
...
#define AT25XE041D_CHIP_SIZE                    SPI_FLASH_SIZE_4MBIT
#define AT25XE041D_MEM_PROT_ALL                 0x1C
///@}

/// @name AT25XE081D - specific definitions
///@{
/** AT25XE081D - specific */
#define AT25XE081D_JEDEC_ID                     0x1F450C
#define AT25XE081D_CHIP_SIZE                    SPI_FLASH_SIZE_8MBIT
#define AT25XE081D_MEM_PROT_ALL                 0x1C
///@}
...
#define AT45DB081E_CHIP_SIZE                    SPI_FLASH_SIZE_8MBIT
#define AT45DB081E_MEM_PROT_ALL                 0x7C
///@}

/// @name AT25FF081 - specific definitions
///@{
/** AT25FF081 - specific */
#define AT25FF081_JEDEC_ID                      0x1F4508
#define AT25FF081_CHIP_SIZE                     SPI_FLASH_SIZE_8MBIT
#define AT25FF081_MEM_PROT_ALL                  0x1C
///@}
...
typedef enum
{
    ...
    /// AT25DN011, AT25DF011, AT25XE011 device index
    AT25xy011_DEV_INDEX,
    ...
    /// AT25DF021A, AT25XE021A device index
    AT25xy021A_DEV_INDEX,

    /// AT25EU0021A device index
    AT25EU0021A_DEV_INDEX,

    /// AT25XE041B device index
    AT25XE041B_DEV_INDEX,

    /// AT25FF041A device index
    AT25FF041A_DEV_INDEX,

    /// AT25SF041B device index
    AT25SF041B_DEV_INDEX,
    ...
    /// AT25XE081D device index
    AT25XE081D_DEV_INDEX,

    /// AT25XE512C, AT25DF512C device index
    AT25xy512C_DEV_INDEX,

    /// AT25EU0011A device index
    AT25EU0011A_DEV_INDEX,

    /// AT25FF081 device index
    AT25FF081_DEV_INDEX,
...
* @note Some SPI flash memories are by default protected after power cycle (e.g. AT25DF021A).
*       If this is the case, then the application must be built with the macro
*       CFG_SPI_FLASH_MEM_PROTECT_USING_STATUS_REG1 defined.
* @return Error code
****************************************************************************************
*/
