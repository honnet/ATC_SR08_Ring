...
#if (BLE_CGM_SERVER)
    {TASK_ID_CGMS,    (prfif_func_t)cgms_prf_itf_get},
#endif // (BLE_CGM_SERVER)

#if (BLE_PLX_SERVER)
    {TASK_ID_PLXS,    (prfif_func_t)plxs_prf_itf_get},
#endif // (BLE_PLX_SERVER)
...
void prf_init_func(bool reset)
{
    ...
    {
        // FW boot profile initialization
        while (BLE_NB_USED_PROFILES && (i < BLE_NB_USED_PROFILES))
        {
            prf->env  = NULL;
...
#endif // only for DA14531 and DA14531-01
